...
Graduation: 144 SKS total — 126 SKS wajib + 18 SKS bidang keahlian
Must complete Tugas Akhir (5 SKS) and Kerja Praktik.

Tracks:
  core     - Mandatory foundation courses (Sem 1-4) and general university courses
...
SAMPLE_CURRICULUM = [
    ...
    Course("EE234101", "Pengantar Teknologi Elektro dan Informatika Cerdas", 2, "genap", tracks=["core"], semester_num=2),
    ...
    Course("EK234201", "Konsep Kecerdasan Artifisial", 3, "ganjil", ["EF234201"], tracks=["core", "ai_ml"], semester_num=3),
    ...
    Course("ER234301", "Perancangan Perangkat Lunak", 3, "genap", ["EF234307"], tracks=["core", "software"], semester_num=4),
    ...
    Course("EF234520", "Pengantar Pengembangan Game (Pengayaan)", 3, "ganjil", tracks=["game"], required=False),
    Course("EF234519", "Pengantar Sistem Cerdas (Pengayaan)", 3, "ganjil", tracks=["ai_ml"], required=False),
    Course("EF234521", "Pengantar Teknologi Basis Data (Pengayaan)", 3, "ganjil", tracks=["database"], required=False),
    ...
    # ══════════════════════════════════════════════
    # Religion courses — student picks one
    Course("UG234901", "Agama Islam", 2, "genap", tracks=["core"], required=False, semester_num=6),
    Course("UG234902", "Agama Kristen", 2, "genap", tracks=["core"], required=False, semester_num=6),
    Course("UG234903", "Agama Katolik", 2, "genap", tracks=["core"], required=False, semester_num=6),
    Course("UG234904", "Agama Hindu", 2, "genap", tracks=["core"], required=False, semester_num=6),
    Course("UG234905", "Agama Buddha", 2, "genap", tracks=["core"], required=False, semester_num=6),
    Course("UG234906", "Agama Khonghucu", 2, "genap", tracks=["core"], required=False, semester_num=6),
    ...
    Course("UG234914", "Bahasa Inggris", 2, "genap", tracks=["core"], required=False, semester_num=6),
    ...
    Course("EF234603", "Kerja Praktik", 4, "genap", ["EF234405"], tracks=["core"], required=False),
    Course("UG234913", "Kewarganegaraan", 2, "genap", tracks=["core"], required=False, semester_num=6),
    Course("UG234915", "Kewirausahaan Berbasis Teknologi", 2, "genap", tracks=["core", "software"], required=False, semester_num=6),
    ...
    Course("ER234402", "Konstruksi Perangkat Lunak", 3, "genap", ["ER234301"], tracks=["software"], required=False, semester_num=6),
    Course("ER234503", "Kualitas Perangkat Lunak", 3, "genap", ["ER234301"], tracks=["software"], required=False, semester_num=6),
    Course("UG234917", "Kuliah Kerja Nyata Tematik (Pengayaan)", 3, "genap", tracks=["core"], required=False, semester_num=6),
    ...
    Course("EF234621", "Pengantar Logika dan Pemrograman (Pengayaan)", 3, "genap", tracks=["core"], required=False),
    Course("EF234620", "Pengantar Proses Mining (Pengayaan)", 3, "genap", tracks=["data"], required=False),
    ...
    Course("EK234501", "Text Mining", 3, "genap", tracks=["ai_ml", "data"], required=False, semester_num=6),

    # ══════════════════════════════════════════════
    # SEMESTER 7 — all elective (required=False)
    # ══════════════════════════════════════════════
    Course("EF234708", "Analisis Data Multivariat", 3, "ganjil", ["EF234402"], tracks=["data", "ai_ml"], required=False),
    Course("UG234916", "Aplikasi Teknologi & Transformasi Digital", 3, "ganjil", tracks=["core"], required=False, semester_num=7),
    Course("ER234403", "Arsitektur Perangkat Lunak", 3, "ganjil", ["ER234301"], tracks=["software"], required=False, semester_num=7),
    Course("UG234912", "Bahasa Indonesia", 2, "ganjil", tracks=["core"], required=False, semester_num=7),
    Course("EF234712", "Big Data", 3, "ganjil", ["EF234404"], tracks=["data", "database"], required=False),
    Course("EF234701", "Etika Profesi", 2, "ganjil", tracks=["core"], required=False),
    Course("ER234505", "Evolusi Perangkat Lunak", 3, "ganjil", ["ER234301"], tracks=["software"], required=False, semester_num=7),
    ...
    Course("EF234722", "Magang", 6, "ganjil", ["EF234405"], tracks=["core"], required=False),
    Course("UG234911", "Pancasila", 2, "ganjil", tracks=["core"], required=False, semester_num=7),
    ...
    Course("EF234702", "Proposal Tugas Akhir", 2, "ganjil", tracks=["core"], required=False),
    ...
    Course("EF234714", "Topik Khusus Algoritma dan Pemrograman", 3, "ganjil", ["EF234405"], tracks=["data"], required=False),
    Course("EF234715", "Topik Khusus Arsitektur dan Jaringan Komputer", 3, "ganjil", ["EF234303"], tracks=["network"], required=False),
    Course("EF234716", "Topik Khusus Grafika, Interaksi dan Game", 3, "ganjil", ["EF234504"], tracks=["game"], required=False),
    Course("EF234717", "Topik Khusus Komputasi Berbasis Jaringan", 3, "ganjil", ["EF234401"], tracks=["network"], required=False),
    Course("EF234718", "Topik Khusus Komputasi Cerdas dan Visi", 3, "ganjil", ["EF234406"], tracks=["ai_ml"], required=False),
    Course("EF234719", "Topik Khusus Manajemen Cerdas Informasi", 3, "ganjil", ["EF234404"], tracks=["database"], required=False),
    Course("EF234720", "Topik Khusus Pemodelan dan Komputasi Terapan", 3, "ganjil", ["EF234402"], tracks=["data"], required=False),
    Course("EF234721", "Topik Khusus Rekayasa Perangkat Lunak", 3, "ganjil", ["ER234301"], tracks=["software"], required=False),
